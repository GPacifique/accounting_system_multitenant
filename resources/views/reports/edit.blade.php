...
<div class="max-w-2xl mx-auto py-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('reports.index') }}" class="px-4 py-2 theme-aware-bg-tertiary rounded hover:bg-gray-300">Back to Reports</a>
    </div>
    ...
    <form action="{{ route('reports.update', $report) }}" method="POST" class="theme-aware-bg-card p-6 rounded shadow">
        ...
        <div class="mb-4">
            <label class="block theme-aware-text-secondary mb-1">Report Data (JSON)</label>
