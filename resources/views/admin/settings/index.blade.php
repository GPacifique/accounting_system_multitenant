    ...
    <div class="bg-gradient-to-r from-gray-700 to-gray-900 rounded-xl shadow-lg p-6 mb-8 text-white">
        <div class="flex items-center justify-between">
            ...
            <div class="flex space-x-3">
                <button onclick="exportSettings()" class="bg-white/20 text-white px-6 py-3 rounded-lg font-semibold hover:bg-white/30 transition">
                    <i class="fas fa-download mr-2"></i>
                    Export Config
                </button>
                <button onclick="importSettings()" class="bg-white text-gray-800 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition">
        ...
        <div class="border-b border-gray-200">
            <nav class="flex space-x-8 px-6" aria-label="Settings Navigation">
                <button onclick="showSection('general')" 
                        class="settings-nav-btn py-4 px-1 border-b-2 border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 font-medium text-sm active"
                        data-section="general">
                    <i class="fas fa-cog mr-2"></i>
                    General
                </button>
                <button onclick="showSection('security')" 
                        class="settings-nav-btn py-4 px-1 border-b-2 border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 font-medium text-sm"
    ...
    <form action="{{ route('admin.settings.update') }}" method="POST" id="settings-form" enctype="multipart/form-data">
        ...
        <div id="general-section" class="settings-section">
            <div class="bg-white rounded-xl shadow-lg p-6 mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label for="app_domain" class="block text-sm font-medium text-gray-700 mb-2">
                            Application Domain
                        </label>
                        <input type="text" 
                               id="app_domain" 
                    ...
                    <div>
                        <label for="max_tenants" class="block text-sm font-medium text-gray-700 mb-2">
                            Maximum Tenants
                        </label>
                        <input type="number" 
                               id="max_tenants" 
        ...
        <div id="storage-section" class="settings-section hidden">
            <div class="bg-white rounded-xl shadow-lg p-6 mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label for="storage_driver" class="block text-sm font-medium text-gray-700 mb-2">
                    ...
                    <div>
                        <label for="auto_backup_frequency" class="block text-sm font-medium text-gray-700 mb-2">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <p class="mt-1 text-xs text-gray-500">Comma-separated list of allowed file extensions</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="api-section" class="settings-section hidden">
            <div class="bg-white rounded-xl shadow-lg p-6 mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        <label class="block text-sm font-medium text-gray-700 mb-3">API Features</label>
                        <div class="space-y-3">
                            <label class="flex items-center">
                                <input type="checkbox" 
                                       name="enable_api" 
                                       ...
                                       class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                <span class="ml-2 text-sm text-gray-700">Enable API Access</span>
                            </label>
                            ...
                            <label class="flex items-center">
                                <input type="checkbox" 
                                       ...
                                       class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                <span class="ml-2 text-sm text-gray-700">Require API Authentication</span>
                            </label>
                            ...
                            <label class="flex items-center">
                                <input type="checkbox" 
                                       ...
                                       class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                <span class="ml-2 text-sm text-gray-700">Enable API Documentation</span>
                            </label>
                            ...
                            <label class="flex items-center">
                                <input type="checkbox" 
                                       ...
                                       class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                <span class="ml-2 text-sm text-gray-700">Log API Requests</span>
                            </label>
                        </div>
                    </div>
                </div>
        ...
        <div id="maintenance-section" class="settings-section hidden">
            <div class="bg-white rounded-xl shadow-lg p-6 mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        <label class="block text-sm font-medium text-gray-700 mb-3">Maintenance Features</label>
                        <div class="space-y-3">
                            <label class="flex items-center">
                                <input type="checkbox" 
                            ...
                            <label class="flex items-center">
                                <input type="checkbox" 
                                       ...
                                       class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                <span class="ml-2 text-sm text-gray-700">Auto Cleanup Old Logs</span>
                            </label>
                    ...
                    <div class="md:col-span-2">
                        <h3 class="text-lg font-semibold text-gray-800 mb-4">System Maintenance Actions</h3>
