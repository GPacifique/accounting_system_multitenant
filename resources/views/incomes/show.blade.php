        ...
        <div class="theme-aware-bg-card rounded-xl shadow-lg overflow-hidden">
            <div class="p-6 sm:p-8">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <h3 class="text-lg font-semibold text-gray-700 border-b pb-2 mb-4">Income Info</h3>
                        <dl class="space-y-4">
                            <div class="flex flex-col">
                                <dt class="text-sm font-medium theme-aware-text-muted">Invoice Number</dt>
                                <dd class="mt-1 text-md text-gray-900">{{ $income->invoice_number ?? '—' }}</dd>
                            </div>
                            <div class="flex flex-col">
                                <dt class="text-sm font-medium theme-aware-text-muted">Payment Status</dt>
                                <dd class="mt-1 text-md text-gray-900">{{ ucfirst($income->payment_status ?? '—') }}</dd>
                            </div>
                            <div class="flex flex-col">
                                <dt class="text-sm font-medium theme-aware-text-muted">Received At</dt>
                                <dd class="mt-1 text-md text-gray-900">{{ optional($income->received_at)->format('Y-m-d') ?? '—' }}</dd>
                            </div>
                        </dl>
                    </div>
                    ...
                    <div>
                        ...
                        <dl class="space-y-4">
                            <div class="flex flex-col">
                                ...
                                <dd class="mt-1 text-md text-gray-900">{{ $income->project->name ?? 'N/A' }}</dd>
                            </div>
                            <div class="flex flex-col">
                                <dt class="text-sm font-medium theme-aware-text-muted">Notes</dt>
                                <dd class="mt-1 text-md text-gray-900">{{ $income->notes ?? '—' }}</dd>
                            </div>
                        </dl>
                    </div>
                </div>
