                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label for="estimated_hours" class="block text-sm font-medium theme-aware-text-secondary mb-2">
                            Estimated Hours
                            <span class="text-xs theme-aware-text-muted">(e.g., 8.5, 24.25)</span>
                        </label>
                        <input type="number" 
                               ...
                               placeholder="Enter hours (e.g., 8.5, 24.25)">
                        @error('estimated_hours')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-xs theme-aware-text-muted">💡 Supports decimal hours (e.g., 8.5 for 8 hours 30 minutes)</p>
                    </div>
